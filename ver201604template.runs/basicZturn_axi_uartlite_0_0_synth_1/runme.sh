...
HD_PWD='C:/Users/vivoz/Documents/WORK_FPGA/Xilinx/ver201604template/ver201604template.runs/basicZturn_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basicZturn_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basicZturn_axi_uartlite_0_0.tcl
