...
HD_PWD='C:/Users/vivoz/Documents/WORK_FPGA/Xilinx/Vivado_project_on_Zturn/with_new_board_def_file/ver201604template/ver201604template.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basicZturn_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basicZturn_wrapper.tcl -notrace
