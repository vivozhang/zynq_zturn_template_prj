...
HD_PWD='C:/ver201604template/ver201604template.runs/basicZturn_xadc_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basicZturn_xadc_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basicZturn_xadc_wiz_0_0.tcl
