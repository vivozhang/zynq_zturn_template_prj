...
HD_PWD='C:/ver201604template/ver201604template.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basicZturn_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basicZturn_wrapper.tcl
