...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -DUNDEFINE_FILE_OPS -DUSE_AMP=1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = addition
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = addition_0
END
