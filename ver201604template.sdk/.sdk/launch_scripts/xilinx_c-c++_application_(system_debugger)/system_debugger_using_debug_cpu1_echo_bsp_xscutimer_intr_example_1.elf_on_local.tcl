...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#1" && jtag_cable_name =~ "Platform Cable USB 00000000000000"} -index 0
dow C:/Users/vivoz/Documents/WORK_FPGA/Xilinx/ver201604template/ver201604template.sdk/cpu1_echo_bsp_xscutimer_intr_example_1/Debug/cpu1_echo_bsp_xscutimer_intr_example_1.elf
targets -set -nocase -filter {name =~ "ARM*#1" && jtag_cable_name =~ "Platform Cable USB 00000000000000"} -index 0
con
